...
export default function StudentProfilePage({ coordinator }) {
	...
	return (
		<div className='flex flex-col justify-center items-center'>
			<PageTitle>Coordinator Profile</PageTitle>

			{/* <span>{JSON.stringify(coordinator, null, 2)}</span> */}
...
export async function getServerSideProps({ req }) {
	try {
		...
		const backendURL = `${process.env.NEXT_PUBLIC_API_URL}/coordinator/profile`;
