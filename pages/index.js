                                ...
                                <tr>
                                    ...
                                    <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <a
                                            ...
                                            href="#"
                                        >
                                           <button className='text-center text-lg py-1 px-3 bg-[#212021] hover:bg-[#414041] shadow-md text-white font-bold rounded-lg border-none cursor-pointer transition-colors'>                                            GO
                                            </button>
                                        </a>
                                    </td>
                                </tr>
...
{/* <div className="flex flex-col">
      <h1 className="text-2xl font-bold text-center mb-4">Your Bundles of GE201</h1>
            <div className="overflow-x-auto">
                <div className="p-1.5 w-full inline-block align-middle">
                    <div className="overflow-hidden border rounded-lg">
                        <table className="min-w-full divide-y divide-gray-200">
...
{/* <div className="flex flex-col">
      <h1 className="text-2xl font-bold text-center mb-4">Creating a Bundle</h1>
            <div className="overflow-x-auto">
                <div className="p-1.5 w-full inline-block align-middle">
                    <div className="overflow-hidden border rounded-lg">
                        <table className="min-w-full divide-y divide-gray-200">
...
{/* <div className="flex flex-col">
      <h1 className="text-2xl font-bold text-center mb-4">Selected GE201 Bundle</h1>
            <div className="overflow-x-auto">
                <div className="p-1.5 w-full inline-block align-middle">
                    <div className="overflow-hidden border rounded-lg">
                        <table className="min-w-full divide-y divide-gray-200">
