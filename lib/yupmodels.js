...
export const inviteStudentModel = {
	initials: {
		student_no: '',
		name: '',
		surname: '',
...
export const addDepartmentModel = {
	...
	schema: Yup.object().shape({
		...
		coordinator_id: Yup.string().required('Coordinator is required'),
	}),
};

export const addMOOCModel = {
	initials: {
		name: '',
		url: '',
		average_hours: 0,
	...
	schema: Yup.object().shape({
		...
		average_hours: Yup.number().required('Average hours is required'),
	}),
};

export const editMOOCModel = {
	initials: {
		id: '',
		name: '',
		url: '',
...
export const editBundleFeedbackModel = {
	initials: {
		comment: '',
	},
	schema: Yup.object().shape({
		comment: Yup.string().required('Bundle feedback is required'),
	}),
};

export const editBundleMoocAddModel = {
	initials: {
		comment: '',
	},
	schema: Yup.object().shape({
...
export const submitBundleModel = {
	initials: {
		comment: '',
	},
	schema: Yup.object().shape({
...
export const addCoordinatorModel = {
	initials: {
		name: '',
		surname: '',
		email: '',
...
export const editCoordinatorModel = {
	initials: {
		id: '',
		name: '',
		surname: '',
...
export const changeCoordinatorModel = {
	initials: {
		coordinator_id: '',
	},
	schema: Yup.object().shape({
